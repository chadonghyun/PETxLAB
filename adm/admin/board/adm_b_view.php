...
$view_sql = "UPDATE boardnoticereg SET user_views = user_views + 1 WHERE number = '$no'";
        ...
        <div class="wrap d-flex justify-content-between">
            ...
            <div class="contents">
                <div class="contents__card card">
                  ...
                  <input type="text" name="title" value="<?=$rows['Board_title']?>" disabled>
                  <h4 class="title">내용</h4>
                  <div class="textarea_wrap disabled">
                    <textarea name="board_contents" id="board_contents" rows="9" disabled><?=$rows['Board_content']?></textarea>
                  </div>
