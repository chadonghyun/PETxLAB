  ...
  <article id="main_b">
    <table id="c_list">
      ...
      <?php
        ...
        $sql = "SELECT qna_title, Board_date, qna_category, number, qna_response, user_id FROM boardqnareg WHERE course_id IN ($sql4) ".($find != "" ? " AND ".$catgo." LIKE '%".$find."%' " : "")." ORDER BY number DESC";
