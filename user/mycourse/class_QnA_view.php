  ...
  <form action="" method="post">
    <div class="wrap">
      ...
      <div class="response_view">
        ...
        <textarea name="reply" id="reply" rows="10" class="reply" readonly><?=$rows['response']?></textarea>
      </div>
      <?php endif; ?>
      <a href= "./class_QnA_list.php?no=1" class="list_view">목록보기</a>
      <a href="./class_QnA_update.php?number=<?=$rows['number'] ?>" class="list_update"<?php if ($rows['qna_response'] == 1) echo ' style="display: none;"'; ?>>게시글 수정</a>
