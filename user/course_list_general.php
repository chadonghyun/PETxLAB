    ...
    <form action="" method="get">
        <div class="sub_title">
            ...
            <nav id="cate">
                <ul>
                    <li>
                        <a href="./course_list_general.php?cate=펫푸드">펫푸드</a>
                    </li>
                    <li>
                        <a href="./course_list_general.php?cate=펫미용">펫미용</a>
                    </li>
                    <li>
                        <a href="./course_list_general.php?cate=펫아이템">펫아이템</a>
                    </li>
                    <li>
                        <a href="./course_list_general.php?cate=행동교정">행동교정</a>
                    </li>
                </ul>
            </nav>
        </div>
