      ...
      <div class="container wrap d-flex justify-content-between">
        ...
        <div class="profile">
          <div class="profile__card card">
            ...
            <p>작성자아이디</p>
            <a href="<?php $_SERVER['DOCUMENT_ROOT']?>/PETxLAB/adm/admin/lecture/adm_l_write.php" title="강의등록" class ="btn btn-100p btn-line">
                강의수정
              </a>
          ...
          <div class="lecreg-detail card">
              ...
              <div class="row">
                  ...
                  <div class="col-md-12 lecreg-desc card">
                    ...
                    <textarea name="course_longdesc" id="course_longdesc"rows="10" readonly>value="<?=$rows['course_longdesc']?>"</textarea>
                  </div>
              </div>    
