...
$sql = "INSERT INTO userregistration (user_id, user_name, user_pass, user_email, user_addr1, user_addr2, user_addr3, user_phone, user_birth_year, user_birth_month, user_birth_day, user_telephone, user_job) 
VALUES ('$id', '$name', '$pass', '$email', '$address1', '$address2', '$address3', '$phone', '$birth1', '$birth2', '$birth3', '$telephone', '$job')"; 
